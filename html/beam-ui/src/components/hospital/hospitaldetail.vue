    ...
    <div class="table" v-loading="exportLoading">
        ...
        <div class="container">
            ...
            <el-table :data="tableData" v-loading="loading" border class="table">
                <el-table-column label="医院编号" align="center" prop="code" width="200"/>
                <el-table-column label="医院名称" align="center" prop="name" width="200"/>
                <el-table-column label="医院级别" align="center" prop="level" width="200"/>
